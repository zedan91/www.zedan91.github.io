const CACHE='azobsstv-v987';
const CORE=['./','./index.html','./assets/azobsstv.css?v=987','./assets/azobsstv.js?v=987','./assets/logo.svg','./manifest.webmanifest?v=987','./data/free.m3u?v=987'];
