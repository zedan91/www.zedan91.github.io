...
- Setiap 1 minit, Cloud Function akan scan Firebase Authentication users.
- Jika emailVerified = false dan umur akaun sudah lebih 1 minit, user akan dipadam.
...
- Untuk trafik kecil AZOBSS, penggunaan function setiap 1 minit biasanya sangat kecil dan berpotensi kekal dalam free-tier, tetapi Google billing tetap bergantung pada penggunaan sebenar.
...
Nota:
- Deletion bukan tepat 60.000 saat. Ia bergantung scheduler, biasanya sekitar 1-2 minit.
- Jangan letak ayat auto-delete kepada user. Di website cukup tulis:
  "Please verify your email within 1 minute, then return and login."
