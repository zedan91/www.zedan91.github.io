const CACHE='azobsstv-v977';
const CORE=['./','./index.html','./assets/azobsstv.css?v=977','./assets/azobsstv.js?v=977','./assets/logo.svg','./manifest.webmanifest?v=977','./data/free.m3u?v=977'];
