const CACHE='azobsstv-v1011';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1011','./assets/azobsstv.js?v=1011','./assets/logo.svg','./manifest.webmanifest?v=1011','./data/free.m3u?v=1011','./data/anime-catalog.json?v=1011'];
