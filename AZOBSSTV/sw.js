const CACHE='azobsstv-v1085';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1085','./assets/azobsstv.js?v=1085','./assets/logo.svg','./manifest.webmanifest?v=1085','./data/free.m3u?v=1085','./data/anime-catalog.json?v=1085','./data/movies-1tube-catalog.json?v=1085','./data/radio-online-my-catalog.json?v=1085'];
