const CACHE='azobsstv-v999';
const CORE=['./','./index.html','./assets/azobsstv.css?v=999','./assets/azobsstv.js?v=999','./assets/logo.svg','./manifest.webmanifest?v=999','./data/free.m3u?v=999','./data/anime-catalog.json?v=999'];
