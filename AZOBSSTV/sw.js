const CACHE='azobsstv-v975';
const CORE=['./','./index.html','./assets/azobsstv.css?v=975','./assets/azobsstv.js?v=975','./assets/logo.svg','./manifest.webmanifest?v=975','./data/free.m3u?v=975'];
