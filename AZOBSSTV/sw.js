const CACHE='azobsstv-v972';
const CORE=['./','./index.html','./assets/azobsstv.css?v=972','./assets/azobsstv.js?v=972','./assets/logo.svg','./manifest.webmanifest?v=972','./data/free.m3u?v=972'];
