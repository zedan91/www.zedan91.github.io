const CACHE='azobsstv-v984';
const CORE=['./','./index.html','./assets/azobsstv.css?v=984','./assets/azobsstv.js?v=984','./assets/logo.svg','./manifest.webmanifest?v=984','./data/free.m3u?v=984'];
