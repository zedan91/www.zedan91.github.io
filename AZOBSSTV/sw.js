const CACHE='azobsstv-v1006';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1006','./assets/azobsstv.js?v=1006','./assets/logo.svg','./manifest.webmanifest?v=1006','./data/free.m3u?v=1006','./data/anime-catalog.json?v=1006'];
