const CACHE='azobsstv-v992';
const CORE=['./','./index.html','./assets/azobsstv.css?v=992','./assets/azobsstv.js?v=992','./assets/logo.svg','./manifest.webmanifest?v=992','./data/free.m3u?v=992','./data/anime-catalog.json?v=992'];
