const CACHE='azobsstv-v991';
const CORE=['./','./index.html','./assets/azobsstv.css?v=991','./assets/azobsstv.js?v=991','./assets/logo.svg','./manifest.webmanifest?v=991','./data/free.m3u?v=991','./data/anime-catalog.json?v=991'];
