const CACHE='azobsstv-v974';
const CORE=['./','./index.html','./assets/azobsstv.css?v=974','./assets/azobsstv.js?v=974','./assets/logo.svg','./manifest.webmanifest?v=974','./data/free.m3u?v=974'];
