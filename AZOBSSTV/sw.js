const CACHE='azobsstv-v995';
const CORE=['./','./index.html','./assets/azobsstv.css?v=995','./assets/azobsstv.js?v=995','./assets/logo.svg','./manifest.webmanifest?v=995','./data/free.m3u?v=995','./data/anime-catalog.json?v=995'];
