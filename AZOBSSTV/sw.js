const CACHE='azobsstv-v1012';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1012','./assets/azobsstv.js?v=1012','./assets/logo.svg','./manifest.webmanifest?v=1012','./data/free.m3u?v=1012','./data/anime-catalog.json?v=1012'];
