const CACHE='azobsstv-v1021';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1021','./assets/azobsstv.js?v=1021','./assets/logo.svg','./manifest.webmanifest?v=1021','./data/free.m3u?v=1021','./data/anime-catalog.json?v=1021','./data/movies-7movies-catalog.json?v=1021'];
