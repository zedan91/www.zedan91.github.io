const CACHE='azobsstv-v1008';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1008','./assets/azobsstv.js?v=1008','./assets/logo.svg','./manifest.webmanifest?v=1008','./data/free.m3u?v=1008','./data/anime-catalog.json?v=1008'];
