const CACHE='azobsstv-v998';
const CORE=['./','./index.html','./assets/azobsstv.css?v=998','./assets/azobsstv.js?v=998','./assets/logo.svg','./manifest.webmanifest?v=998','./data/free.m3u?v=998','./data/anime-catalog.json?v=998'];
