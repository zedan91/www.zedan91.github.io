const CACHE='azobsstv-v1002';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1002','./assets/azobsstv.js?v=1002','./assets/logo.svg','./manifest.webmanifest?v=1002','./data/free.m3u?v=1002','./data/anime-catalog.json?v=1002'];
