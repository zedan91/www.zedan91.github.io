const CACHE='azobsstv-v966';
const CORE=['./','./index.html','./assets/azobsstv.css?v=966','./assets/azobsstv.js?v=966','./assets/logo.svg','./manifest.webmanifest?v=966','./data/free.m3u?v=966'];
