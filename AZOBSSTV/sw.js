const CACHE='azobsstv-v993';
const CORE=['./','./index.html','./assets/azobsstv.css?v=993','./assets/azobsstv.js?v=993','./assets/logo.svg','./manifest.webmanifest?v=993','./data/free.m3u?v=993','./data/anime-catalog.json?v=993'];
