const CACHE='azobsstv-v1010';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1010','./assets/azobsstv.js?v=1010','./assets/logo.svg','./manifest.webmanifest?v=1010','./data/free.m3u?v=1010','./data/anime-catalog.json?v=1010'];
