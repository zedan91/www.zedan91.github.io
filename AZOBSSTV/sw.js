const CACHE='azobsstv-v968';
const CORE=['./','./index.html','./assets/azobsstv.css?v=968','./assets/azobsstv.js?v=968','./assets/logo.svg','./manifest.webmanifest?v=968','./data/free.m3u?v=968'];
