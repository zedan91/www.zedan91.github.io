const CACHE='azobsstv-v1004';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1004','./assets/azobsstv.js?v=1004','./assets/logo.svg','./manifest.webmanifest?v=1004','./data/free.m3u?v=1004','./data/anime-catalog.json?v=1004'];
