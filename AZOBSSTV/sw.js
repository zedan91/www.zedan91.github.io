const CACHE='azobsstv-v1031';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1031','./assets/azobsstv.js?v=1031','./assets/logo.svg','./manifest.webmanifest?v=1031','./data/free.m3u?v=1031','./data/anime-catalog.json?v=1031','./data/movies-1tube-catalog.json?v=1031','./data/radio-online-my-catalog.json?v=1031'];
