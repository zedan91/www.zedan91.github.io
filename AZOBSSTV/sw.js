const CACHE='azobsstv-v988';
const CORE=['./','./index.html','./assets/azobsstv.css?v=988','./assets/azobsstv.js?v=988','./assets/logo.svg','./manifest.webmanifest?v=988','./data/free.m3u?v=988'];
