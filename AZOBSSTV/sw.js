const CACHE='azobsstv-v996';
const CORE=['./','./index.html','./assets/azobsstv.css?v=996','./assets/azobsstv.js?v=996','./assets/logo.svg','./manifest.webmanifest?v=996','./data/free.m3u?v=996','./data/anime-catalog.json?v=996'];
