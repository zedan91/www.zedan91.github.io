const CACHE='azobsstv-v1013';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1013','./assets/azobsstv.js?v=1013','./assets/logo.svg','./manifest.webmanifest?v=1013','./data/free.m3u?v=1013','./data/anime-catalog.json?v=1013'];
