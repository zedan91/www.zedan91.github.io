const CACHE='azobsstv-v1005';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1005','./assets/azobsstv.js?v=1005','./assets/logo.svg','./manifest.webmanifest?v=1005','./data/free.m3u?v=1005','./data/anime-catalog.json?v=1005'];
