const CACHE='azobsstv-v965';
const CORE=['./','./index.html','./assets/azobsstv.css?v=965','./assets/azobsstv.js?v=965','./assets/logo.svg','./manifest.webmanifest?v=965','./data/free.m3u?v=965'];
