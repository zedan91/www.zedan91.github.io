const CACHE='azobsstv-v971';
const CORE=['./','./index.html','./assets/azobsstv.css?v=971','./assets/azobsstv.js?v=971','./assets/logo.svg','./manifest.webmanifest?v=971','./data/free.m3u?v=971'];
