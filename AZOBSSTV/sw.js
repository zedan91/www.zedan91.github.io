const CACHE='azobsstv-v1003';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1003','./assets/azobsstv.js?v=1003','./assets/logo.svg','./manifest.webmanifest?v=1003','./data/free.m3u?v=1003','./data/anime-catalog.json?v=1003'];
