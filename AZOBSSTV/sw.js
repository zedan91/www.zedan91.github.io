const CACHE='azobsstv-v1029';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1029','./assets/azobsstv.js?v=1029','./assets/logo.svg','./manifest.webmanifest?v=1029','./data/free.m3u?v=1029','./data/anime-catalog.json?v=1029','./data/movies-1tube-catalog.json?v=1029','./data/radio-online-my-catalog.json?v=1029'];
