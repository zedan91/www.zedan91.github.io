const CACHE='azobsstv-v973';
const CORE=['./','./index.html','./assets/azobsstv.css?v=973','./assets/azobsstv.js?v=973','./assets/logo.svg','./manifest.webmanifest?v=973','./data/free.m3u?v=973'];
