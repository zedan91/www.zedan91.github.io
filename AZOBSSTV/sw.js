const CACHE='azobsstv-v1001';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1001','./assets/azobsstv.js?v=1001','./assets/logo.svg','./manifest.webmanifest?v=1001','./data/free.m3u?v=1001','./data/anime-catalog.json?v=1001'];
