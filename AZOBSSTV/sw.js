const CACHE='azobsstv-v979';
const CORE=['./','./index.html','./assets/azobsstv.css?v=979','./assets/azobsstv.js?v=979','./assets/logo.svg','./manifest.webmanifest?v=979','./data/free.m3u?v=979'];
