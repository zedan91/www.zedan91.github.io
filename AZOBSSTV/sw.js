const CACHE='azobsstv-v997';
const CORE=['./','./index.html','./assets/azobsstv.css?v=997','./assets/azobsstv.js?v=997','./assets/logo.svg','./manifest.webmanifest?v=997','./data/free.m3u?v=997','./data/anime-catalog.json?v=997'];
