const CACHE='azobsstv-v1009';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1009','./assets/azobsstv.js?v=1009','./assets/logo.svg','./manifest.webmanifest?v=1009','./data/free.m3u?v=1009','./data/anime-catalog.json?v=1009'];
