const CACHE='azobsstv-v1024';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1024','./assets/azobsstv.js?v=1024','./assets/logo.svg','./manifest.webmanifest?v=1024','./data/free.m3u?v=1024','./data/anime-catalog.json?v=1024','./data/movies-1tube-catalog.json?v=1024','./data/radio-mana2-catalog.json?v=1024'];
