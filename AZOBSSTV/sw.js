const CACHE='azobsstv-v964';
const CORE=['./','./index.html','./assets/azobsstv.css?v=964','./assets/azobsstv.js?v=964','./assets/logo.svg','./manifest.webmanifest?v=964','./data/free.m3u?v=964'];
