const CACHE='azobsstv-v1000';
const CORE=['./','./index.html','./assets/azobsstv.css?v=1000','./assets/azobsstv.js?v=1000','./assets/logo.svg','./manifest.webmanifest?v=1000','./data/free.m3u?v=1000','./data/anime-catalog.json?v=1000'];
