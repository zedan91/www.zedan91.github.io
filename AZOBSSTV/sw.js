const CACHE='azobsstv-v970';
const CORE=['./','./index.html','./assets/azobsstv.css?v=970','./assets/azobsstv.js?v=970','./assets/logo.svg','./manifest.webmanifest?v=970','./data/free.m3u?v=970'];
