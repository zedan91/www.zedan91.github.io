const CACHE='azobsstv-v990';
const CORE=['./','./index.html','./assets/azobsstv.css?v=990','./assets/azobsstv.js?v=990','./assets/logo.svg','./manifest.webmanifest?v=990','./data/free.m3u?v=990'];
