const CACHE='azobsstv-v969';
const CORE=['./','./index.html','./assets/azobsstv.css?v=969','./assets/azobsstv.js?v=969','./assets/logo.svg','./manifest.webmanifest?v=969','./data/free.m3u?v=969'];
