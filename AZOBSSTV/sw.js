const CACHE='azobsstv-v967';
const CORE=['./','./index.html','./assets/azobsstv.css?v=967','./assets/azobsstv.js?v=967','./assets/logo.svg','./manifest.webmanifest?v=967','./data/free.m3u?v=967'];
