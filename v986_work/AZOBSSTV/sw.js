const CACHE='azobsstv-v986';
const CORE=['./','./index.html','./assets/azobsstv.css?v=986','./assets/azobsstv.js?v=986','./assets/logo.svg','./manifest.webmanifest?v=986','./data/free.m3u?v=986'];
