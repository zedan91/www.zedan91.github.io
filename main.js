    ...
    const API_BASE = (window.AZOBSS_LUCKY_DRAW_API || localStorage.getItem('azobssLuckyDrawBackendUrl') || 'https://azobss-lucky-draw-api.onrender.com').replace(/\/$/, '');
    ...
    const luckyDrawI18n = {
      ms: {
        ...
        intro: 'User yang login boleh join Lucky Draw selepas link produk Software/CAD yang dishare dibuka oleh orang lain.',
        rule1: 'Login dahulu sebelum join Lucky Draw.',
        rule2: 'Share mana-mana produk Software/CAD yang ada button Share for Lucky Draw.',
        rule3: 'Tekan Check Product Share untuk semak status sebelum join.',
        linkLabel: 'Syarat share produk',
        ...
        referralNeedDesc: 'Link produk perlu dibuka oleh orang lain.',
        ...
        noteTitle: 'Nota syarat share produk',
        note1: 'Your shared product link must be opened by at least 1 other person before you can join the current Lucky Draw. Free Software can be shared, but no commission is counted because there is no sale transaction.',
        note2: 'Opening your own product link does not count.',
        ...
        loginPlaceholder: 'Share produk Software/CAD untuk aktifkan join',
        productRequirement: 'Open any Software/CAD product that has the <strong>Share for Lucky Draw</strong> button. Join becomes active after the product link is opened by another person. Free Software sharing has no commission.',
        loginActive: 'Log in first to activate Lucky Draw.',
        loginCheck: 'Log in first to check product sharing.',
        checking: 'Checking product share...',
        alreadyJoined: 'You have already joined the current Lucky Draw.',
        referralValid: 'The product click is valid. The Join Lucky Draw button is now active.',
        joinBlockedDevice: 'The product share requirement is valid, but this device has already been used to join the current Lucky Draw.',
        joinBlockedIp: 'The product share requirement is valid, but this IP address has already been used to join the current Lucky Draw.',
        joinBlockedAccount: 'This account has already joined the current Lucky Draw.',
        joinBlockedGeneric: 'The product share requirement is valid, but you cannot join this month yet.',
        referralMissing: 'Share your username link with someone else. Join becomes active after at least 1 person opens your link.',
        referralCount: 'Valid product click: ',
        noReferral: 'No valid product clicks yet',
        copyLogin: 'Log in first before opening Software Tools.',
        copied: 'Username link copied. Join becomes active after someone else opens this link.',
        shareLogin: 'Log in first before opening CAD Tools.',
        shareText: 'Join AZOBSS Lucky Draw: ',
        shareOpened: 'The share link has been opened. Join only becomes active after someone else opens your link.',
      ...
      en: {
        ...
        intro: 'Logged-in users can join the Lucky Draw after their Software/CAD product share link is opened by another person.',
        rule1: 'Log in first before joining the Lucky Draw.',
        rule2: 'Share any Software/CAD product that has the Share for Lucky Draw button.',
        rule3: 'Click Check Product Share to check your status before joining.',
        linkLabel: 'Product share requirement',
        copyInvite: 'Open Software Tools',
        shareWebsite: 'Open CAD Tools',
        checkReferral: 'Check Product Share',
        joinLucky: 'Join Lucky Draw',
        ...
        noteTitle: 'Product share note',
        note1: 'Your product share link must be opened by at least 1 other person before you can join this month\'s Lucky Draw. Free Software can be shared, but no commission is counted because there is no sale transaction.',
        ...
        loginPlaceholder: 'Share a Software/CAD product to unlock join',
        productRequirement: 'Open any Software/CAD product with the <strong>Share for Lucky Draw</strong> button. Join activates after another person opens that product link. Free Software share has no commission.',
        loginActive: 'Log in first to activate Lucky Draw.',
        loginCheck: 'Log in first to check product share.',
        checking: 'Checking product share...',
        alreadyJoined: 'You have already joined this month\'s Lucky Draw.',
        referralValid: 'Product click is valid. Join Lucky Draw button is now active.',
        joinBlockedDevice: 'Product share is valid, but this device has already been used to join this month.',
        joinBlockedIp: 'Product share is valid, but this IP address has already been used to join this month.',
        joinBlockedAccount: 'This account has already joined the Lucky Draw this month.',
        joinBlockedGeneric: 'Product share is valid, but you cannot join this month.',
        referralMissing: 'Share any Software/CAD product with a Share button. Join will be active after at least 1 person opens your product link.',
        referralCount: 'Valid product click: ',
        noReferral: 'No valid product click yet',
        copyLogin: 'Log in first before opening Software Tools.',
        copied: 'Choose any Software/CAD product with a Share button, then tap Share for Lucky Draw.',
        shareLogin: 'Log in first before opening CAD Tools.',
        shareText: 'AZOBSS product: ',
    ...
    function updateInvitePanel(){
      ...
      if (els.inviteLink) els.inviteLink.value = luckyDrawLang === 'en' ? 'Open any Software/CAD product with the Share for Lucky Draw button' : 'Buka produk Software/CAD yang ada button Share for Lucky Draw';
      if (els.productRequirementText) els.productRequirementText.innerHTML = tr('productRequirement');
    ...
    async function joinLuckyDraw(){
      ...
      if (!(localStorage.getItem(getShareKey(user)) === '1' || referralClickCountCache > 0)) {
        setStatus('Belum ada klik valid dari link produk. Share mana-mana Software/CAD yang ada button Share dahulu.', true);
        return;
      }
      const usernameKey = normalizeUsername(user.usernameKey || user.name);
