...
(function(){
  ...
  function addLikeStyle(){
    ...
    style.textContent = `
      ...
      /* AZOBSS 447: align bookmark and share controls in one vertical rail. */
      ...
      @media(max-width:700px){.download-card > .az-item-like-btn,.software-card > .az-item-like-btn,.software-product-card > .az-item-like-btn,.cad-card > .az-item-like-btn,.cad-item > .az-item-like-btn,.cad-resource-card > .az-item-like-btn,.cad-tool-card > .az-item-like-btn{top:16px!important;right:14px!important;width:34px!important;height:34px!important;min-width:34px!important;min-height:34px!important;max-width:34px!important;max-height:34px!important}.download-card > .az-lucky-product-share-btn,.software-card > .az-lucky-product-share-btn,.software-product-card > .az-lucky-product-share-btn,.cad-card > .az-lucky-product-share-btn,.cad-item > .az-lucky-product-share-btn,.cad-resource-card > .az-lucky-product-share-btn,.cad-tool-card > .az-lucky-product-share-btn{top:60px!important;right:14px!important;width:34px!important;height:34px!important;min-width:34px!important;min-height:34px!important;max-width:34px!important;max-height:34px!important}}
