...
function purchaseDetailRowHtml(r){
  ...
  if(paid){
    // My Purchases user view: do not show download link here.
    // Receipt and real download link are handled by customer email.
    actionHtml = `<div class="user-pa-action-with-count"><span class="user-pa-download is-locked">📧 Email Sent</span></div>`;
  }else{
