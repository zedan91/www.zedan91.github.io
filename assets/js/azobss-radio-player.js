...
(function(){
  ...
  const STATIONS = [
    { id:'era', name:'ERA', label:'ERA', query:'ERA', country:'MY', web:'https://audio1.syok.my/era' },
    { id:'sinar', name:'SINAR', label:'SINAR', query:'SINAR', country:'MY', web:'https://audio1.syok.my/sinar' },
    { id:'zayan', name:'ZAYAN', label:'ZAYAN', query:'ZAYAN', country:'MY', web:'https://audio1.syok.my/zayan' },
    { id:'ikim', name:'IKIM FM', label:'IKIM FM', query:'IKIM', country:'MY', web:'https://ikimfm.my/' },
    { id:'custom', name:'Custom URL', label:'Custom URL', query:'', country:'', web:'' }
  ];
