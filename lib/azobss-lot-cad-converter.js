...
function convertLotZip(zipBuffer, format, options = {}) {
  ...
  return { format: 'dwg', buffer: dwg.buffer, report: Object.assign({}, dxf.report, { dwgSignature: dwg.signature, dwgInputProfile: 'AC1015 lean LibreDWG profile + flattened TEXT alignment' }) };
}
